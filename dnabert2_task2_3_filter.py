...
def process_full_sequences(full_seq_dir, taxonomy_dicts, label_encoders, thresholds):
    ...
    for label_type in ['order', 'family', 'genus']:
        ...
        output_dir = os.path.join("/work/sgk270/dnabert2_task2_new", f'{label_type}_full_embed')
...
def process_contig_data(valid_labels, contig_dir, taxonomy_dicts, label_encoders, contig_lengths):
    for label_type in ['order', 'family', 'genus']:
        ...
        for split in ['train', 'val']:
            ...
            output_dir = os.path.join("/work/sgk270/dnabert2_task2_new", f'{label_type}_contig_embed')
        ...
        for length in contig_lengths:
            ...
            length_output_dir = os.path.join("/work/sgk270/dnabert2_task2_new", f'{label_type}_contig_embed', f'length_{length}')
...
def main():
    ...
    FULL_SEQ_DIR = '/work/sgk270/dnabert2_task2_new/full_embed'
    CONTIG_DIR = '/work/sgk270/dnabert2_task2_new/contig_embed'
