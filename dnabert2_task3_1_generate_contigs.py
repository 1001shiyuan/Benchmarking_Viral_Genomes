...
def read_valid_sequence_ids(metadata_path: str) -> Set[str]:
    """
    Read metadata from CSV file and identify sequences with lifestyle information.
    Returns: Set of sequence_ids that have at least one lifestyle level.
    """
    valid_seq_ids = set()
    ...
    with open(metadata_path, 'r') as f:
        ...
        for row in reader:
            ...
            # Check if the sequence has at least one lifestyle level filled
            if row['lifestyle']:
                valid_seq_ids.add(seq_id)
    
    print(f"Found {len(valid_seq_ids)} sequences with lifestyle information")
...
def main():
    ...
    CONTIGS_DIR = "/work/sgk270/dnabert2_task3_new/contigs"
    FULL_SEQS_DIR = "/work/sgk270/dnabert2_task3_new/full_seqs"
    ...
    # Read metadata to identify sequences with lifestyle information
