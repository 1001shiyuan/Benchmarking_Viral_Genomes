...
#SBATCH --output=genalm_classify_genus_%j.out
#SBATCH --error=genalm_classify_genus_%j.err
...
mkdir -p /work/sgk270/genalm_task2/genus_output

# Run classification for genus
python classify.py \
  --label_type genus \
  --output_dir /work/sgk270/genalm_task2/genus_output \
