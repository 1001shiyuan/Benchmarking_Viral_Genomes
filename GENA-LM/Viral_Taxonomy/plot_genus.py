...
def plot_combined_training_history(output_dir, label_type="genus"):
    ...
    # Add a global title
    fig.suptitle(f'GENA-LM Genus Classification Training Metrics', fontsize=16)
...
def plot_metrics_by_length(results_df, output_dir, label_type="genus"):
    ...
    plt.tight_layout()
    fig.suptitle(f'GENA-LM Genus Classification Performance by Sequence Length (Test Set)', y=1.02, fontsize=16)
