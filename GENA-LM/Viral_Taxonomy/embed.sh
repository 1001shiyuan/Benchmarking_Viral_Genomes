...
mkdir -p /work/sgk270/genalm_task2/contig_embed
mkdir -p /work/sgk270/genalm_task2/full_embed
...
python /work/sgk270/genalm_task2/embed.py \
  ...
  --output_dir /work/sgk270/genalm_task2/contig_embed \
  --full_output_dir /work/sgk270/genalm_task2/full_embed \
  --batch_size 32