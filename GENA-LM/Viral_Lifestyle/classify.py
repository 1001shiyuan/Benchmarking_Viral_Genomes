...
def process_contig_lengths(args, early_stop_patience, batch_size, learning_rate):
    ...
    # Updated to use genalm task3 paths
    base_dir = "/work/sgk270/genalm_task3"
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="/work/sgk270/genalm_task3/lifestyle_output")
    ...
    print("\nRunning classification for GENA-LM lifestyle embeddings")
