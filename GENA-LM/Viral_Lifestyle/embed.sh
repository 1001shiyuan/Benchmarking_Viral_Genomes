...
#SBATCH --output=genalm_lifestyle_embed_%j.out
#SBATCH --error=genalm_lifestyle_embed_%j.err
# Load anaconda module
module load anaconda3
# Activate the genalm environment created for task2
source activate genalm
# Create output directories if they don't exist
mkdir -p /work/sgk270/genalm_task3/lifestyle_contig_embed
mkdir -p /work/sgk270/genalm_task3/lifestyle_full_embed
# Set cache directory for huggingface to avoid permission issues
export HF_HOME=/work/sgk270/genalm_task3/.cache/huggingface
...
python /work/sgk270/genalm_task3/embed.py \
  ...
  --output_dir /work/sgk270/genalm_task3/lifestyle_contig_embed \
  --full_output_dir /work/sgk270/genalm_task3/lifestyle_full_embed \
  --batch_size 32