...
def process_contig_lengths(args, early_stop_patience, batch_size, learning_rate):
    ...
    combined_dir = "lifestyle_contig_embed"
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="lifestyle_output")
    ...
    print("\nRunning classification for lifestyle data")
    ...
    full_embeddings_dir = "lifestyle_full_embed"
