...
def plot_combined_training_history(output_dir):
    ...
    # Add a global title
    fig.suptitle('Lifestyle Classification Training Metrics', fontsize=16)
    
    # Save the combined figure
    plt.tight_layout(rect=[0, 0, 1, 0.96])  # Adjust for the suptitle
    plt.savefig(os.path.join(output_dir, 'lifestyle_training_curves.png'), dpi=300, bbox_inches='tight')
    plt.close()
...
def plot_metrics_by_length(results_df, output_dir):
    ...
    plt.tight_layout()
    fig.suptitle('Lifestyle Classification Performance by Sequence Length (Test Set)', y=1.02, fontsize=16)
    plt.savefig(os.path.join(output_dir, 'lifestyle_metrics_by_length.png'), dpi=300, bbox_inches='tight')
    plt.close()
