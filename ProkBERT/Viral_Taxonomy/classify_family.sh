...
#SBATCH --output=prokbert_classify_family_%j.out
#SBATCH --error=prokbert_classify_family_%j.err
...
mkdir -p /work/sgk270/prokbert_task2/family_output

# Run classification for family
python classify.py \
  --label_type family \
  --output_dir /work/sgk270/prokbert_task2/family_output \
