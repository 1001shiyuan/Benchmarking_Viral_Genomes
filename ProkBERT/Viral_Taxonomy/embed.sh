...
mkdir -p /work/sgk270/prokbert_task2/contig_embed
mkdir -p /work/sgk270/prokbert_task2/full_embed
...
python /work/sgk270/prokbert_task2/embed.py \
  --model_name_or_path neuralbioinfo/prokbert-mini \
  --contigs_path /work/sgk270/dnabert2_task2/contigs \
  --full_seqs_path /work/sgk270/dnabert2_task2/full_seqs \
  --output_dir /work/sgk270/prokbert_task2/contig_embed \
  --full_output_dir /work/sgk270/prokbert_task2/full_embed \
  --batch_size 32