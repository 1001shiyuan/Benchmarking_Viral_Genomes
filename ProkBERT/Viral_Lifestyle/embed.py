...
class PrecomputeArguments:
    ...
    # Output to the prokbert_task3 directory
    output_dir: str = field(default="/work/sgk270/prokbert_task3/lifestyle_contig_embed")
    full_output_dir: str = field(default="/work/sgk270/prokbert_task3/lifestyle_full_embed")
        ...
        for sequences, sequence_ids, labels_dict, _ in dataloader:
            ...
            for tokens in tokens_before:
                ...
                if token_length > 512:  
                    ...
                    stats['truncated_length'] += (token_length - 512)
