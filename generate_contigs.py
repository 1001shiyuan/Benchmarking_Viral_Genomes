...
def main():
    ...
    # Define paths - CORRECTED FOR TASK3 DIRECTORY
    INPUT_FILE = "/work/sgk270/dataset_for_benchmarking/lifestyle/combined_sequences.fasta"
    CONTIGS_DIR = "/work/sgk270/dnabert2_task3/lifestyle_contigs"
    FULL_SEQS_DIR = "/work/sgk270/dnabert2_task3/lifestyle_full_seqs"
    ...
    print("\nGenerating contigs of all lengths for lifestyle sequences...")
    ...
    for contig_length in CONTIG_LENGTHS:
        print(f"\nProcessing lifestyle contigs of length {contig_length}bp...")
