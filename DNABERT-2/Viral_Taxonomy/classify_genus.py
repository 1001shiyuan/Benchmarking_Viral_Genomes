...
def load_embeddings(embeddings_dir, filename):
    ...
    # Always use genus labels for this script
    label_type = 'genus'
...
def train_and_evaluate(embeddings_dir, output_dir, model_prefix, batch_size, learning_rate, num_epochs, early_stop_patience, label_type="genus", length_test_dirs=None):
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="genus_output")
    ...
    # Fixed label type for genus classification
    label_type = "genus"
