...
def load_embeddings(embeddings_dir, filename):
    ...
    # Always use family labels for this script
    label_type = 'family'
...
def train_and_evaluate(embeddings_dir, output_dir, model_prefix, batch_size, learning_rate, num_epochs, early_stop_patience, label_type="family", length_test_dirs=None):
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="family_output")
    ...
    # Fixed label type for family classification
    label_type = "family"

    print(f"\nRunning classification for {label_type}")
    os.makedirs(args.output_dir, exist_ok=True)
    
    # Process contigs
    process_contig_lengths(args, label_type, args.early_stop_patience, batch_size, learning_rate)
    
    # Process full sequences
    full_embeddings_dir = f"{label_type}_full_embed"
