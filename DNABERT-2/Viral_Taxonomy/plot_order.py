...
def plot_combined_training_history(output_dir, label_type="order"):
    ...
    plt.savefig(os.path.join(output_dir, f'{label_type}_training_curves.png'), dpi=300, bbox_inches='tight')
    plt.close()
...
def plot_metrics_by_length(results_df, output_dir, label_type="order"):
    ...
    plt.savefig(os.path.join(output_dir, f'{label_type}_metrics_by_length.png'), dpi=300, bbox_inches='tight')
    plt.close()
