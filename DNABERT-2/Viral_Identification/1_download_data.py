...
def download_genomes():
    """Download negative samples: bacterial (20 per genus) and all archaeal genomes."""
    # Create negative samples directory
    negative_output_dir = "./negative"
    os.makedirs(negative_output_dir, exist_ok=True)
    
    # Download bacterial genomes (20 per genus)
    print("Downloading bacterial genomes from RefSeq (20 per genus)")
    run_genome_updater("bacteria", negative_output_dir, genomes_per_genus=20)
