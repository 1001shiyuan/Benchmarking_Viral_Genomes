...
def train_and_evaluate(embeddings_dir, output_dir, model_prefix, batch_size, learning_rate, num_epochs, early_stop_patience, length_test_dirs):
    ...
    if model_prefix == "full":
        ...
        if os.path.exists(final_path):
            print(f"\nSaved final evaluation to {final_path}")
        else:
            print(f"\nWARNING: Failed to save evaluation file to {final_path}")
    ...
    for test_dir in length_test_dirs:
        ...
        if os.path.exists(result_path):
            ...
            print(f"WARNING: Failed to save {result_path}")
...
def main():
    ...
    base_dir = "/work/sgk270/dnabert2_task3_new/contig_embed_labeled"
    ...
    full_dir = "/work/sgk270/dnabert2_task3_new/full_embed_labeled"
