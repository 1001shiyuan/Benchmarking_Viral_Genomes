...
def plot_combined_training_history(output_dir, label_type="order"):
    ...
    plt.savefig(os.path.join(output_dir, "order_training_curves_genalm.png"), dpi=300)
    plt.close()
...
def plot_metrics_by_length(results_df, output_dir, label_type="order"):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, "order_metrics_by_length_genalm.png"), dpi=300)
    plt.close()
