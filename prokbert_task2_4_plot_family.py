...
def plot_combined_training_history(output_dir, label_type="family"):
    ...
    fig.suptitle("Family Classification Training Curves", fontsize=16)
...
def plot_metrics_by_length(results_df, output_dir, label_type="family"):
    ...
    fig.suptitle("Family Classification Performance by Sequence Length", fontsize=16, y=1.02)
    plt.tight_layout()
...
def main():
    label_type = 'family'
    output_dir = 'family_output'  # <-- LOCAL folder
