...
@dataclass
class DataArguments:
    contigs_path: str = field(default="/work/sgk270/dnabert2_task1_new/pos_contigs")
    full_seqs_path: str = field(default="/work/sgk270/dnabert2_task1_new/pos_full_seqs")
...
class PrecomputeArguments:
    ...
    output_dir: str = field(default="/work/sgk270/dnabert2_task1_new/pos_contig_embed")
    full_output_dir: str = field(default="/work/sgk270/dnabert2_task1_new/pos_full_embed")
...
def process_full_sequences(base_model, tokenizer, data_path, output_dir, precompute_args, device, stats):
    ...
    for split in ['train', 'val', 'test']:
        ...
        try:
            ...
            log_with_time(f"Error processing full sequence {split}: {e}")
            traceback.print_exc()
